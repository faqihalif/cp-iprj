        ...
        <>
            ...
            <TabPanel as="div">
                ...
                <div className="space-y-2">
                    <p className="text-sm text-justify text-gray-700 md:text-base">Institut Pendidikan dan Riset JEC (INSPIRE JEC) is an Indonesian Non-Profit Organization under the aegis of Yayasan Pilar Mitra Pendidikan.</p>
